...
func TestBundleProvidedAPIsClusterRolesGenerator(t *testing.T) {
	t.Run("single owned CRD generates 4 ClusterRoles", func(t *testing.T) {
		...
		objs, err := generators.BundleProvidedAPIsClusterRolesGenerator(rv1, render.Options{ProvidedAPIsClusterRoles: true})
		require.NoError(t, err)
	...
	t.Run("invalid CRD name returns error", func(t *testing.T) {
		...
		_, err := generators.BundleProvidedAPIsClusterRolesGenerator(rv1, render.Options{ProvidedAPIsClusterRoles: true})
		require.Error(t, err)
